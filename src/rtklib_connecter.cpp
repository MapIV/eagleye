...
void xyz2enu(double ECEF_x, double ECEF_y, double ECEF_z, double base_ECEF_x, double base_ECEF_y, double base_ECEF_z,
             double* enu_x, double* enu_y, double* enu_z)
{
  ...
  *enu_y = ((-sin_phi * cos_lam * (ECEF_x - base_ECEF_x)) + (-sin_phi * sin_lam * (ECEF_y - base_ECEF_y)) +
            (cos_phi * (ECEF_z - base_ECEF_z)));
  *enu_z = ((cos_phi * cos_lam * (ECEF_x - base_ECEF_x)) + (cos_phi * sin_lam * (ECEF_y - base_ECEF_y)) +
            (sin_phi * (ECEF_z - base_ECEF_z)));
}

void xyz2enu_vel(double Vel_x, double Vel_y, double Vel_z, double base_ECEF_x, double base_ECEF_y, double base_ECEF_z,
